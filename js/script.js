function tampilkanForm() {
    ...
    caraPengerjaanDiv.innerHTML = '';  // Kosongkan cara pengerjaan sebelumnya
    inputField.innerHTML = '';  // Kosongkan input sebelumnya

    // Tampilkan gambar dan input sesuai dengan jenis segitiga
    if (jenisSegitiga) {
        gambarSegitiga.style.display = 'block'; // Menampilkan gambar
...
function hitung(event) {
    ...
    if (jenisSegitiga === 'samasisi') {
        ...
        // Cara pengerjaan untuk segitiga sama sisi
        caraPengerjaan = `
        ...
        // Cara pengerjaan untuk segitiga sama kaki
        caraPengerjaan = `
        ...
        // Cara pengerjaan untuk segitiga sembarang
        caraPengerjaan = `
        ...
        // Cara pengerjaan untuk segitiga siku-siku
        caraPengerjaan = `
    ...
    // Tampilkan hasil dan cara pengerjaan
